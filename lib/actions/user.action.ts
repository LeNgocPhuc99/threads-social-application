...
export async function getActivity(userId: string) {
    try {
        ...
        // collect all the thread ids (replies - comment) from "children" field
        const childThreadIds = userThreads.reduce((prevVal, userThread) => {
            return prevVal.concat(userThread.children)
        }, [])
